    ...
    public function attemptRegister()
    {
        ...
        $rules = config('Validation')->registrationRules ?? [
            'username'    => [
                ...
                'errors' => [
                    ...
                    'alpha_numeric_space' => 'Tidak bisa menngunakan karakter alphanumerik dan spasi.',
                    'min_length' => 'Panjang minimal adalah 3 karakter.',
                    'max_length' => 'Panjang maskimal adalah 30 karaketer.',
        ...
        $rules = [
            'password'    => [
                ...
                'errors' => [
                    'required' => 'Password harus diisi.',
                    'strong_password' => 'Masukkan password yang lebih kuat.'
                ]
            ],
            'pass_confirm'    => [
                ...
                'errors' => [
                    'required' => 'Password harus diisi.',
                    'matches[password]' => 'Password yang anda masukkan tidak sesuai.'
                ]
            ],
        ];
    ...
    public function attemptReset()
    {
        ...
        $rules = [
            'token'    => [
                'rules' => 'required',
                'errors' => [
                    'required' => 'Kode token harus diisi.'
                ]
            ],
            'email'    => [
                'rules' => 'required|valid_email',
