        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    ...
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <?php if (!empty($kec2)) : ?>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('admin/gambut/administrasi/prov/') . '/' . $kec2[0]['idprov']; ?>';"><?= $kec2[0]['nama_prov']; ?></span></li>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('admin/gambut/administrasi/kabkot/') . '/' . $kec2[0]['idkabkot']; ?>';"><?= $kec2[0]['nama_kabkot']; ?></span></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span role="button" class="badge outline-badge-dark"> <?= $kec2[0]['nama_kec']; ?></span>
                                </li>
                            <?php endif; ?>
                        </ol>
                ...
                <div id="head-3" class="seperator-header layout-top-spacing">
                    <?php if (!empty($kec2)) : ?>
                        <h4 class="">DATA DESA KECAMATAN <?= strtoupper($kec2[0]['nama_kec']); ?></h4>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <div style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
                                    <?php if (isset($kec2)) : ?>
                                        <form action="<?= ($kec2[0]['idkec']); ?>/simpan_desa" method="post">
                                            <div class="modal-body">
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="kodedesa">
                                                            <p>Masukkan kode Desa.</p>
                                                        </label>
                                                        <input type="text" placeholder="Kode Desa..." class="form-control <?= ($validation->hasError('kodedesa')) ? 'is-invalid' : ''; ?>" id="kodedesa" name="kodedesa" value="<?= old('kodedesa'); ?>" autofocus>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('kodedesa'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label for="namadesa">
                                                            <p>Masukkan nama Desa.</p>
                                                        </label>
                                                        <input type="text" placeholder="Nama Desa..." class="form-control <?= ($validation->hasError('namadesa')) ? 'is-invalid' : ''; ?>" id="namadesa" name="namadesa" value="<?= old('namadesa'); ?>">
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('namadesa'); ?>
                                                        </div>
                                                    </div>
                                                    <input type="hidden" id="kodekec" name="kodekec" value="<?= ($kec2[0]['kodekec']); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#edit_4<?= $var['id']; ?>" title="Sunting Record">Sunting</button>
                                                        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#hapus_4<?= $var['id']; ?>" title="Hapus Record">
                                                        ...
                                                        <a href="<?= base_url('admin/gambut/administrasi/lemdes/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-warning" title="Data Lembaga Desa">
                ...
                <div id="modal-desa">
                    <?php foreach ($desa as $var) : ?>
                        <div id="edit_desa">
                            <div class="modal fade" id="edit_4<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">UPDATE DATA DESA</h5>
                                        ...
                                        <form action="<?= $var['idkec']; ?>/edit_desa/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="kodedesa" type="text" name="kodedesa" value="<?= $var['kode_desa']; ?>" class="form-control">
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label for="namadesa">
                                                        <p>Sunting nama Desa.</p>
                                                    </label>
                                                    <input id="namadesa" type="text" name="namadesa" value="<?= $var['nama_desa']; ?>" class="form-control">
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label for="kodekec">
                                                        <p>Sunting kode Kecamatan.</p>
                                                    </label>
                                                    <select class="form-select" id="kodekec" name="kodekec" value="<?= $var['kode_kec']; ?>">
                                                        <option selected="<?= $var['kode_kec']; ?>"><?= $var['kode_kec']; ?></option>
                                                        <?php foreach ($kec as $var1) : ?>
                                                            <option value="<?= $var1['kode_kec']; ?>"><?= $var1['kode_kec']; ?> - <?= $var1['nama_kec']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
                        ...
                        <div id="hapus_desa">
                            <div class="modal fade" id="hapus_4<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">HAPUS DATA DESA</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-rounded-x" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M10 10l4 4m0 -4l-4 4"></path>
                                        ...
                                        <form action="<?= $var['idkec']; ?>/hapus_desa/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <p><strong>Nama Desa : </strong><?= $var['nama_desa']; ?></p>
                                                <p><strong>Kode Kecamatan : </strong><?= $var['kode_kec']; ?></p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
