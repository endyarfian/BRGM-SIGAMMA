        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Arahan Tindakan Restorasi</li>
                        </ol>
                    </nav>
                </div>
                <!-- /BREADCRUMB -->
                ...
                <div id="head-2" class="seperator-header layout-top-spacing">
                    <h4 class="">DATA ARAHAN TINDAKAN RESTORASI</h4>
                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <div style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
                                    <form action="<?= base_url('/admin/gambut/tindakan/simpan_tindakan') ?>" method="post">
                                        <div class="modal-body">
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <label for="kodetindakan">
                                                        <p>Masukkan kode arahan tindakan.</p>
                                                    </label>
                                                    <input type="text" placeholder="Kode arahan tindakan..." class="form-control <?= ($validation->hasError('kodetindakan')) ? 'is-invalid' : ''; ?>" id="kodetindakan" name="kodetindakan" value="<?= old('kodetindakan'); ?>">
                                                    <div class="invalid-feedback">
                                                        <?= $validation->getError('kodetindakan'); ?>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <label for="namatindakan">
                                                        <p>Masukkan nama arahan tindakan.</p>
                                                    </label>
                                                    <input type="text" placeholder="Nama arahan tindakan..." class="form-control <?= ($validation->hasError('namatindakan')) ? 'is-invalid' : ''; ?>" id="namatindakan" name="namatindakan" value="<?= old('namatindakan'); ?>">
                                                    <div class="invalid-feedback">
                                                        <?= $validation->getError('namatindakan'); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <label for="deskripsi">
                                                        <p>Masukkan deskripsi arahan tindakan.</p>
                                                    </label>
                                ...
                                <table id="user" class="table dt-table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Kode Arahan Tindakan</th>
                                            <th>Nama Arahan Tindakan</th>
                                            <th>Deskripsi</th>
                                            <th>Tindakan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php foreach ($tindakan as $var) : ?>
                                            <tr>
                                                <td scope="row"><?= $no++; ?></td>
                                                <td><?= $var['kode_tindakan_restorasi']; ?></td>
                                                <td><?= $var['nama_tindakan_restorasi']; ?></td>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <a href="<?= base_url('admin/gambut/tindakan/subtindakan'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-warning" title="Data sub-arahan tindakan">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">UPDATE DATA ARAHAN TINDAKAN</h5>
                                        ...
                                        <form action="<?= base_url('/admin/gambut/tindakan/edit_tindakan') ?>/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label for="kodetindakan">
                                                            <p>Sunting kode arahan tindakan.</p>
                                                        </label>
                                                        <input id="kodetindakan" type="text" name="kodetindakan" value="<?= $var['kode_tindakan_restorasi']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="namatindakan">
                                                            <p>Sunting nama arahan tindakan.</p>
                                                        </label>
                                                        <input id="namatindakan" type="text" name="namatindakan" value="<?= $var['nama_tindakan_restorasi']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label for="deskripsi">
                                                            <p>Sunting deskripsi arahan tindakan.</p>
                                                        </label>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" id="edit_tindakan" class="btn btn-submit btn-sm">Simpan</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div id="hapus_tindakan">
                            <div class="modal fade" id="hapus_1<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">HAPUS DATA ARAHAN TINDAKAN</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-rounded-x" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M10 10l4 4m0 -4l-4 4"></path>
                                        ...
                                        <form action="<?= base_url('/admin/gambut/tindakan/hapus_tindakan') ?>/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <p><strong>Kode Arahan Tindakan : </strong><?= $var['kode_tindakan_restorasi']; ?></p>
                                                <p><strong>Nama Arahan Tindakan : </strong><?= $var['nama_tindakan_restorasi']; ?></p>
