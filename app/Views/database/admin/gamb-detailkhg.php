        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Sub KHG</li>
                        </ol>
                    </nav>
                    <br>
                        ...
                        <ol class="breadcrumb">
                            ...
                            <?php if (!empty($khg2)) : ?>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <button class="badge outline-badge-dark" href="#"><?= ($khg2[0]['nama']); ?></button>
                                </li>
                            <?php endif; ?>
                        </ol>
                    </nav>
                ...
                <div id="head-2" class="seperator-header layout-top-spacing">
                    <?php if (!empty($khg2)) : ?>
                        <h4 class="">DATA SUB-KHG DALAM <?= ($khg2[0]['nama']); ?></h4>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <div style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
                                    <?php if (!empty($khg2)) : ?>
                                        <form action="<?= ($khg2[0]['idkhg']); ?>/simpan_subkhg" method="post">
                                            <div class="modal-body">
                                                <div class="row mb-2">
                                                    <div class="col">
                                                        <label for="kodesubkhg">
                                                            <p>Masukkan kode Sub-KHG.</p>
                                                        </label>
                                                        <input type="text" placeholder="Kode sub-KHG..." class="form-control <?= ($validation->hasError('kodesubkhg')) ? 'is-invalid' : ''; ?>" id="kodesubkhg" name="kodesubkhg" value="<?= old('kodesubkhg'); ?>" autofocus>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('kodesubkhg'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label for="namasubkhg">
                                                            <p>Masukkan nama Sub-KHG.</p>
                                                        </label>
                                                        <input type="text" placeholder="Nama sub-KHG..." class="form-control <?= ($validation->hasError('namasubkhg')) ? 'is-invalid' : ''; ?>" id="namasubkhg" name="namasubkhg" value="<?= old('namasubkhg'); ?>">
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('namasubkhg'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label for="luassubkhg">
                                                            <p>Masukkan luas Sub-KHG.</p>
                                                        </label>
                                                        <input type="text" placeholder="Luas sub-KHG..." class="form-control <?= ($validation->hasError('luassubkhg')) ? 'is-invalid' : ''; ?>" id="luassubkhg" name="luassubkhg" value="<?= old('luassubkhg'); ?>">
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('luassubkhg'); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-2">
                                                    <div class="col">
                                                        <label for="satuansubkhg">
                                                            <p>Masukkan satuan luas Sub-KHG.</p>
                                                        </label>
                                                        <input type="text" placeholder="Satuan luas sub-KHG..." class="form-control <?= ($validation->hasError('satuansubkhg')) ? 'is-invalid' : ''; ?>" id="satuansubkhg" name="satuansubkhg" value="<?= old('satuansubkhg'); ?>">
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('satuansubkhg'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <input type="hidden" id="kodekhg" name="kodekhg" value="<?= ($khg2[0]['kodekhg']); ?>">
                                                    </div>
                                                    <div class="col">
                                ...
                                <table id="user" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php foreach ($subkhg as $var) : ?>
                                            <tr>
                                                <td scope="row"><?= $no++; ?></td>
                                                <td><?= $var['kodekhg']; ?></td>
                                                <td><?= $var['kode_sub_khg']; ?></td>
                                                <td><?= $var['nama_sub_khg']; ?></td>
                                                <td><?= $var['luas']; ?></td>
                                                <td><?= $var['satuan']; ?></td>
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <button type="button" class="btn btn-success " data-bs-toggle="modal" data-bs-target="#edit_2<?= $var['id']; ?>" title="Sunting Record">Sunting</button>
                                                        <button type="button" class="btn btn-success " data-bs-toggle="modal" data-bs-target="#hapus_2<?= $var['id']; ?>" title="Hapus Record">
                                                        ...
                                                        <a href="<?= base_url('admin/gambut/kawasan/subkhg/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-warning" title="Data Sub-KHG">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">UPDATE DATA SUB-KHG</h5>
                                        ...
                                        <form action="<?= $var['idkhg']; ?>/edit_subkhg/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" id="kodekhg" name="kodekhg" value="<?= $var['kodekhg']; ?>">
                                                        <option selected><?= $var['kodekhg']; ?></option>
                                                        <?php foreach ($khg as $var1) : ?>
                                                            <option value="<?= $var1['kode_khg']; ?>"><?= $var1['kode_khg']; ?> - <?= $var1['nama']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label for="kodesubkhg">
                                                        <p>Sunting kode sub-KHG.</p>
                                                    </label>
                                                    <input id="kodesubkhg" type="text" name="kodesubkhg" value="<?= $var['kode_sub_khg']; ?>" class="form-control">
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label for="namasubkhg">
                                                        <p>Sunting nama sub-KHG.</p>
                                                    </label>
                                                    <input id="namasubkhg" type="text" name="namasubkhg" value="<?= $var['nama_sub_khg']; ?>" class="form-control">
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label for="luassubkhg">
                                                        <p>Sunting luas sub-KHG.</p>
                                                    </label>
                                                    <input id="luassubkhg" type="text" name="luassubkhg" value="<?= $var['luas']; ?>" class="form-control">
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label for="satuansubkhg">
                                                        <p>Sunting satuan luas sub-KHG.</p>
                                                    </label>
                                                    <input id="satuansubkhg" type="text" name="satuansubkhg" value="<?= $var['satuan']; ?>" class="form-control">
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label for="satuansubkhg">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" id="edit_subkhg" class="btn btn-submit btn-sm">Simpan</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div id="hapus_subkhg">
                            <div class="modal fade" id="hapus_2<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">HAPUS DATA SUB-KHG</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-rounded-x" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M10 10l4 4m0 -4l-4 4"></path>
                                        ...
                                        <form action="<?= $var['idkhg']; ?>/hapus_subkhg/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <p><strong>Kode KHG : </strong><?= $var['kodekhg']; ?></p>
                                                <p><strong>Kode sub-KHG : </strong><?= $var['kode_sub_khg']; ?></p>
                                                <p><strong>Nama sub-KHG : </strong><?= $var['nama_sub_khg']; ?></p>
                                                <p><strong>Luasan sub-KHG: </strong><?= $var['luas']; ?></p>
                                                <p><strong>Satuan Luas : </strong><?= $var['satuan']; ?></p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
                                                <button type="submit" id="hapus_subkhg" class="btn btn-danger btn-sm">Hapus</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
