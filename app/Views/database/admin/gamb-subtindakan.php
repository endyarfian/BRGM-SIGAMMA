        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Arahan Tindakan Restorasi</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Sub Arahan Tindakan Restorasi</li>
                        </ol>
                    </nav>
                    <br>
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('admin/gambut/tindakan'); ?>';">Data Arahan Tindakan</span></li>
                            <?php if (!empty($tindakan2)) : ?>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <button class="badge outline-badge-dark" href="#"><?= ($tindakan2[0]['namatindakan']); ?></button>
                                </li>
                            <?php endif; ?>
                        </ol>
                    </nav>
                ...
                <div id="head-2" class="seperator-header layout-top-spacing">
                    <?php if (!empty($tindakan2)) : ?>
                        <h4 class="">DATA SUB-ARAHAN TINDAKAN RESTORASI DALAM <?= strtoupper($tindakan2[0]['namatindakan']); ?></h4>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <div style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
                                    <?php if (!empty($tindakan2)) : ?>
                                        <form action="<?= ($tindakan2[0]['idtindakan']); ?>/simpan_subtindakan" method="post">
                                            <div class="modal-body">
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="kodesubtindakan">
                                                            <p>Masukkan kode sub-arahan tindakan restorasi.</p>
                                                        </label>
                                                        <input type="text" placeholder="Kode sub-arahan tindakan..." class="form-control <?= ($validation->hasError('kodesubtindakan')) ? 'is-invalid' : ''; ?>" id="kodesubtindakan" name="kodesubtindakan" value="<?= old('kodesubtindakan'); ?>">
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('kodesubtindakan'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label for="nama">
                                                            <p>Masukkan nama sub-arahan tindakan restorasi.</p>
                                                        </label>
                                                        <input type="text" placeholder="Nama sub-arahan tindakan..." class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" id="nama" name="nama" value="<?= old('nama'); ?>">
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="deskripsi">
                                                            <p>Masukkan deskripsi sub-arahan tindakan restorasi.</p>
                                                        </label>
                                                ...
                                                <input type="hidden" id="kodetindakan" name="kodetindakan" value="<?= ($tindakan2[0]['kodetindakan']); ?>">
                                            </div>
                                            <div class="modal-footer">
                                                <button type="submit" id="simpan_tindakan" class="btn btn-outline-success btn-sm">
                                ...
                                <table id="user" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php foreach ($subtindakan as $var) : ?>
                                            <tr>
                                                <td scope="row"><?= $no++; ?></td>
                                                <td><?= $var['kodetindakan']; ?></td>
                                                <td><?= $var['kode_sub_tindakan_restorasi']; ?></td>
                                                <td><?= $var['nama_sub_tindakan_restorasi']; ?></td>
                                                <td style="white-space: pre-line;"><?= $var['deskripsi']; ?></td>
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#edit_1<?= $var['id']; ?>" title="Sunting Record">Sunting</button>
                                                        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#hapus_1<?= $var['id']; ?>" title="Hapus Record">
                ...
                <!-- tabel subtindakan -->
                <!-- modal subtindakan -->
                <div id="modal-subtindakan">
                    <?php foreach ($subtindakan as $var) : ?>
                        <div id="edit_tindakan">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">UPDATE DATA SUB-ARAHAN TINDAKAN</h5>
                                        ...
                                        <form action="<?= $var['idtindakan']; ?>/edit_subtindakan/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="kodetindakan">
                                                            <p>Pilih kode arahan tindakan restorasi.</p>
                                                        </label>
                                                        <select class="form-select" id="kodetindakan" name="kodetindakan" value="<?= $var['kodetindakan']; ?>">
                                                            <option selected><?= $var['kodetindakan']; ?></option>
                                                            <?php foreach ($tindakan as $var1) : ?>
                                                                <option value="<?= $var1['kode_tindakan_restorasi']; ?>"><?= $var1['kode_tindakan_restorasi']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    <div class="col">
                                                        <label for="kodesubtindakan">
                                                            <p>Sunting kode sub-arahan tindakan restorasi.</p>
                                                        </label>
                                                        <input id="kodesubtindakan" type="text" name="kodesubtindakan" value="<?= $var['kode_sub_tindakan_restorasi']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="nama">
                                                            <p>Sunting nama sub-arahan tindakan restorasi.</p>
                                                        </label>
                                                        <input id="nama" type="text" name="nama" value="<?= $var['nama_sub_tindakan_restorasi']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="deskripsi">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" id="edit_subtindakan" class="btn btn-submit btn-sm">Simpan</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div id="hapus_subtindakan">
                            <div class="modal fade" id="hapus_1<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">HAPUS DATA SUB-ARAHAN TINDAKAN</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-rounded-x" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M10 10l4 4m0 -4l-4 4"></path>
                                        ...
                                        <form action="<?= $var['idtindakan']; ?>/hapus_subtindakan/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <p><strong>Kode Arahan Tindakan Restorasi : </strong><?= $var['kodetindakan']; ?></p>
                                                <p><strong>Kode Sub-Arahan Tindakan Restorasi : </strong><?= $var['kode_sub_tindakan_restorasi']; ?></p>
                                                <p><strong>Nama Sub-Arahan Tindakan Restorasi : </strong><?= $var['nama_sub_tindakan_restorasi']; ?></p>
                                                <p><strong>Deskripsi : </strong><?= $var['deskripsi']; ?></p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
                                                <button type="submit" id="hapus_subtindakan" class="btn btn-danger btn-sm">Hapus</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
