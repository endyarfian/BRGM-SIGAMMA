        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    ...
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <?php if (!empty($kabkot2)) : ?>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('admin/gambut/administrasi/prov/') . '/' . $kabkot2[0]['idprov']; ?>';"><?= $kabkot2[0]['nama_prov']; ?></span></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span role="button" class="badge outline-badge-dark"> <?= $kabkot2[0]['nama_kabkot']; ?></span>
                                </li>
                            <?php endif; ?>
                        </ol>
                ...
                <div id="head-3" class="seperator-header layout-top-spacing">
                    <?php if (!empty($kabkot2)) : ?>
                        <h4 class="">DATA KECAMATAN KABUPATEN/KOTA <?= strtoupper($kabkot2[0]['nama_kabkot']); ?></h4>
                    <?php endif; ?>
                </div>
                <div class="row">
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <div style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
                                    <?php if (isset($kabkot2)) : ?>
                                        <form action="<?= ($kabkot2[0]['idkabkot']); ?>/simpan_kec" method="post">
                                            <div class="modal-body">
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label for="kodekec">
                                                            <p>Masukkan kode Kecamatan.</p>
                                                        </label>
                                                        <input type="text" placeholder="Kode Kecamatan..." class="form-control <?= ($validation->hasError('kodekec')) ? 'is-invalid' : ''; ?>" id="kodekec" name="kodekec" value="<?= old('kodekec'); ?>" autofocus>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('kodekec'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label for="namakec">
                                                            <p>Masukkan nama Kecamatan.</p>
                                                        </label>
                                                        <input type="text" placeholder="Nama Kecamatan..." class="form-control <?= ($validation->hasError('namakec')) ? 'is-invalid' : ''; ?>" id="namakec" name="namakec" value="<?= old('namakec'); ?>">
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('namakec'); ?>
                                                        </div>
                                                    </div>
                                                    <input type="hidden" id="kodekabkot" name="kodekabkot" value="<?= ($kabkot2[0]['kodekabkot']); ?>">
                                                </div>
                                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#edit_3<?= $var['id']; ?>" title="Sunting Record">Sunting</button>
                                                        <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#hapus_3<?= $var['id']; ?>" title="Hapus Record">
                                                        ...
                                                        <a href="<?= base_url('admin/gambut/administrasi/kec/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-warning" title="Data Desa">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">UPDATE DATA KECAMATAN</h5>
                                        ...
                                        <form action="<?= $var['idkabkot']; ?>/edit_kec/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="kodekec" type="text" name="kodekec" value="<?= $var['kode_kec']; ?>" class="form-control">
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label for="namakec">
                                                        <p>Sunting nama Kecamatan.</p>
                                                    </label>
                                                    <input id="namakec" type="text" name="namakec" value="<?= $var['nama_kec']; ?>" class="form-control">
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label for="kodekabkot">
                                                        <p>Sunting kode Kabupaten/Kota.</p>
                                                    </label>
                                                    <select class="form-select" id="kodekabkot" name="kodekabkot" value="<?= $var['kode_kabkot']; ?>">
                                                        <option selected="<?= $var['kode_kabkot']; ?>"><?= $var['kode_kabkot']; ?></option>
                                                        <?php foreach ($kabkot as $var1) : ?>
                                                            <option value="<?= $var1['kode_kabkot']; ?>"><?= $var1['kode_kabkot']; ?> - <?= $var1['nama_kabkot']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
                        ...
                        <div id="hapus_kec">
                            <div class="modal fade" id="hapus_3<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">HAPUS DATA KECAMATAN</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-rounded-x" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M10 10l4 4m0 -4l-4 4"></path>
                                        ...
                                        <form action="<?= $var['idkabkot']; ?>/hapus_kec/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <p><strong>Nama Kecamatan : </strong><?= $var['nama_kec']; ?></p>
                                                <p><strong>Kode Kabupaten/Kota : </strong><?= $var['kode_kabkot']; ?></p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
                                                <button type="submit" id="hapus_kec" class="btn btn-danger btn-sm">Hapus</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
