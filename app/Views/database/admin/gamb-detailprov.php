                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <div style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
                                    <?php if (!empty($prov2)) : ?>
                                        <form action="<?= ($prov2[0]['idprov']); ?>/simpan_kabkot" method="post">
                                            <div class="modal-body">
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="kodekabkot">
                                                            <p>Masukkan kode Kabupaten/Kota.</p>
                                                        </label>
                                                        <input type="text" placeholder="Kode Kabupaten/Kota..." class="form-control <?= ($validation->hasError('kodekabkot')) ? 'is-invalid' : ''; ?>" id="kodekabkot" name="kodekabkot" value="<?= old('kodekabkot'); ?>" autofocus>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('kodekabkot'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label for="namakabkot">
                                                            <p>Masukkan nama Kabupaten/Kota.</p>
                                                        </label>
                                                        <input type="text" placeholder="Nama Kabupaten/Kota..." class="form-control <?= ($validation->hasError('namakabkot')) ? 'is-invalid' : ''; ?>" id="namakabkot" name="namakabkot" value="<?= old('namakabkot'); ?>">
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('namakabkot'); ?>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <a href="<?= base_url('admin/gambut/administrasi/kabkot/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-warning" title="Data Kecamatan">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">UPDATE DATA KABUPATEN/KOTA</h5>
                                        ...
                                        <form action="<?= $var['idprov']; ?>/edit_kabkot/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="kodekabkot" type="text" name="kodekabkot" value="<?= $var['kode_kabkot']; ?>" class="form-control">
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label for="namakabkot">
                                                        <p>Sunting nama Kabupaten/Kota.</p>
                                                    </label>
                                                    <input id="namakabkot" type="text" name="namakabkot" value="<?= $var['nama_kabkot']; ?>" class="form-control">
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label for="kodeprov">
                                                    ...
                                                    <select class="form-select" id="kodeprov" name="kodeprov" value="<?= $var['kodeprov']; ?>">
                                                        <option selected><?= $var['kodeprov']; ?></option>
                        ...
                        <div id="hapus_kabkot">
                            <div class="modal fade" id="hapus_2<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">HAPUS DATA KABUPATEN/KOTA</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-rounded-x" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M10 10l4 4m0 -4l-4 4"></path>
                                        ...
                                        <form action="<?= $var['idprov']; ?>/hapus_kabkot/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <p><strong>Nama Kabupaten/Kota : </strong><?= $var['nama_kabkot']; ?></p>
                                                <p><strong>Kode Provinsi : </strong><?= $var['kodeprov']; ?></p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
                                                <button type="submit" id="hapus_kabkot" class="btn btn-danger btn-sm">Hapus</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
