        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Dokumen perencanaan</li>
                ...
                <div id="head-2" class="seperator-header layout-top-spacing">
                    <?php if (!empty($doc2)) : ?>
                        <h4 class="">DATA SASARAN KEGIATAN DALAM DOKUMEN <?= strtoupper($doc2[0]['judul']); ?></h4>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <div style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
                                    <?php if (!empty($doc2)) : ?>
                                        <form action="<?= ($doc2[0]['idrencana']); ?>/simpan_sasaran" method="post">
                                            <div class="modal-body">
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="kodetarget">
                                                            <p>Masukkan kode sasaran kegiatan.</p>
                                                        </label>
                                                        <input type="text" placeholder="Kode sasaran kegiatan..." class="form-control <?= ($validation->hasError('kodetarget')) ? 'is-invalid' : ''; ?>" id="kodetarget" name="kodetarget" value="<?= old('kodetarget'); ?>" autofocus>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('kodetarget'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label for="kodekhg">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <a href="<?= base_url('admin/gambut/rencana/sasaran-intervensi/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-warning" title="Data Sasatan Intervensi">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">UPDATE DATA SASARAN</h5>
                                        ...
                                        <form action="<?= $var['idrencana']; ?>/edit_sasaran/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="koderencana">
                                                        <p>Sunting kode dokumen rencana.</p>
                                                    </label>
                                                    <input id="koderencana" type="text" name="koderencana" value="<?= $var['koderencana']; ?>" class="form-control">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="kodetarget">
                        ...
                        <div id="hapus_kabkot">
                            <div class="modal fade" id="hapus_2<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">HAPUS DATA SASARAN</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-rounded-x" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M10 10l4 4m0 -4l-4 4"></path>
