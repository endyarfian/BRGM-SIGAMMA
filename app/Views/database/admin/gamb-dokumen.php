        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Dokumen Perencanaan</li>
                        </ol>
                    </nav>
                </div>
                <!-- /BREADCRUMB -->
                ...
                <div id="head-1" class="seperator-header layout-top-spacing">
                    <h4 class="">DATA DOKUMEN RENCANA KEGIATAN</h4>
                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <div style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
                                    <form action="rencana/simpan_rencana" method="post">
                                        <div class="modal-body">
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <label for="kodedoc">
                                                        <p>Masukkan kode dokumen kegiatan.</p>
                                                    </label>
                                                    <input type="text" placeholder="Kode dokumen..." class="form-control <?= ($validation->hasError('kodedoc')) ? 'is-invalid' : ''; ?>" id="kodedoc" name="kodedoc" value="<?= old('kodedoc'); ?>" autofocus>
                                                    <div class="invalid-feedback">
                                                        <?= $validation->getError('kodedoc'); ?>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <label for="tipedoc">
                                                        <p>Masukkan tipe dokumen kegiatan.</p>
                                                    </label>
                                                    <input type="text" placeholder="Tipe dokumen..." class="form-control <?= ($validation->hasError('tipedoc')) ? 'is-invalid' : ''; ?>" id="tipedoc" name="tipedoc" value="<?= old('tipedoc'); ?>">
                                                    <div class="invalid-feedback">
                                                        <?= $validation->getError('tipedoc'); ?>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <label for="judul">
                                                        <p>Masukkan judul dokumen kegiatan.</p>
                                                    </label>
                                                    <input type="text" placeholder="Judul dokumen..." class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" id="judul" name="judul" value="<?= old('judul'); ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <label for="tahun">
                                                        <p>Masukkan tahun disahkan.</p>
                                                    </label>
                                                    <input type="text" placeholder="Tahun disahkan..." class="form-control <?= ($validation->hasError('tahun')) ? 'is-invalid' : ''; ?>" id="tahun" name="tahun" value="<?= old('tahun'); ?>">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col">
                                                    <label for="berlaku">
                                                        <p>Masukkan tanggal berlaku dokumen kegiatan.</p>
                                                    </label>
                                                    <input type="date" placeholder="Tanggal berlaku..." class="form-control <?= ($validation->hasError('berlaku')) ? 'is-invalid' : ''; ?>" id="berlaku" name="berlaku" value="<?= old('berlaku'); ?>">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col">
                                                    <label for="berakhir">
                                                        <p>Masukkan tanggal berakhir dokumen kegiatan.</p>
                                                    </label>
                                                    <input type="date" placeholder="Tanggal berakhir..." class="form-control <?= ($validation->hasError('berakhir')) ? 'is-invalid' : ''; ?>" id="berakhir" name="berakhir" value="<?= old('berakhir'); ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <label for="pengesah">
                                                        <p>Masukkan nama pengesah dokumen kegiatan.</p>
                                                    </label>
                                                    <input type="text" placeholder="Nama pengesah..." class="form-control <?= ($validation->hasError('pengesah')) ? 'is-invalid' : ''; ?>" id="pengesah" name="pengesah" value="<?= old('pengesah'); ?>">
                                                    <div class="invalid-feedback">
                                                        <?= $validation->getError('pengesah'); ?>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <label for="file">
                                                        <p>Masukkan link download dokumen kegiatan.</p>
                                                    </label>
                                                    <input type="text" placeholder="Link download..." class="form-control <?= ($validation->hasError('file')) ? 'is-invalid' : ''; ?>" id="file" name="file" value="<?= old('file'); ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <a href="<?= base_url('admin/gambut/rencana/sasaran/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-warning" title="Data Sasaran Kegiatan">
                                                        ...
                                                        <a href="<?= base_url('admin/gambut/rencana/kegiatan/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-warning" title="Data Perencanaan Kegiatan">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-chevron-right" width="32" height="32" viewBox="0 0 25 25" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <div id="modal-doc">
                    <?php foreach ($doc as $var) : ?>
                        <div class="modal fade" id="file<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalCenterTitle">...(FUNCTION BELUM ADA)</h5>
                                    ...
                                    <form action="<?= base_url('/admin/gambut/rencana/upload'); ?>" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            <div class="alert alert-icon-left alert-light-success alert-dismissible fade show mb-4" role="alert">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-text" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M14 3v4a1 1 0 0 0 1 1h4"></path>
                                                ...
                                                Unggah dokumen PDF untuk <?= $var['judul']; ?>.
                                                <br> Pastikan berukuran kurang dari 100 Mb.
                                                <br>
                                            </div>
                                            <?= csrf_field(); ?>
                                            <div class="mb-3">
                                                <label for="judul">
                                                    <p>Masukkan nama file tanpa spasi diikuti ekstensi.</p>
                                                </label>
                                                <input type="text" placeholder="Contoh: RTT_PROVINSI_JAMBI_2021_2024.pdf" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" id="judul" name="judul" value="<?= old('judul'); ?>">
                                                <div class="invalid-feedback">
                                                    <?= $validation->getError('judul'); ?>
                                                </div>
                                            </div>
                                            <div class="form-control-file-wrapper">
                                                <button id="btn_upload2" class="btn btn-success" style="margin-left: -5px;" title="Cari dalam file explorer">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-device-desktop-search" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                        <path d="M11.5 16h-7.5a1 1 0 0 1 -1 -1v-10a1 1 0 0 1 1 -1h16a1 1 0 0 1 1 1v6.5"></path>
                                                        <path d="M7 20h4"></path>
                                                        <path d="M9 16v4"></path>
                                                ...
                                                <span id="file_info" style="margin-left: 10px;">Pilih documen PDF (.pdf)</span>
                                                <span id="file_size"></span>
                                            </div>
                                            <input type="file" id="file_pdf" class="form-control-file" name="file_pdf" accept=".pdf" required style="display: none;">
                                        </div>
                                        <div class="modal-footer">
                                            <button type="submit" class="btn btn-success btn-sm">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-upload" width="32" height="32" viewBox="0 0 30 27" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M14 3v4a1 1 0 0 0 1 1h4"></path>
                                                    <path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z"></path>
                        ...
                        <div id="edit_doc">
                            <div class="modal fade" id="edit_1<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">UPDATE DATA DOKUMEN</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-rounded-x" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M10 10l4 4m0 -4l-4 4"></path>
                                        ...
                                        <form action="rencana/edit_rencana/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                <div class="alert alert-icon-left alert-light-success alert-dismissible fade show mb-4" role="alert">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label for="kodedoc">
                                                            <p>Sunting data kode dokumen kegiatan.</p>
                                                        </label>
                                                        <input id="kodedoc" type="text" name="kodedoc" value="<?= $var['kode_rencana']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="tipedoc">
                                                            <p>Sunting tipe dokumen kegiatan.</p>
                                                        </label>
                                                        <input id="tipedoc" type="text" name="tipedoc" value="<?= $var['tipe_rencana']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label for="judul">
                                                            <p>Sunting judul dokumen kegiatan.</p>
                                                        </label>
                                                        <input id="judul" type="text" name="judul" value="<?= $var['judul']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="tahun">
                                                            <p>Sunting tahun disahkan.</p>
                                                        </label>
                                                        <input id="tahun" type="text" name="tahun" value="<?= $var['tahun']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label for="berlaku">
                                                            <p>Sunting tanggal berlaku dokumen kegiatan.</p>
                                                        </label>
                                                        <input id="berlaku" type="date" name="berlaku" value="<?= $var['tgl_berlaku']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="berakhir">
                                                            <p>Sunting tanggal berakhir dokumen kegiatan.</p>
                                                        </label>
                                                        <input id="berakhir" type="date" name="berakhir" value="<?= $var['tgl_berakhir']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label for="pengesah">
                                                            <p>Sunting nama pengesah dokumen kegiatan.</p>
                                                        </label>
                                                        <input id="pengesah" type="text" name="pengesah" value="<?= $var['pengesah']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label for="file">
                                                            <p>Sunting link download dokumen kegiatan.</p>
                                                        </label>
                                                        <input id="file" type="text" name="file" value="<?= $var['file']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
                                                <button type="submit" id="edit_doc" class="btn btn-submit btn-sm">Simpan</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div id="hapus_doc">
                            <div class="modal fade" id="hapus_1<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">HAPUS DATA DOKUMEN</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-rounded-x" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M10 10l4 4m0 -4l-4 4"></path>
                                        ...
                                        <form action="rencana/hapus_rencana/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <p><strong>Kode Dokumen : </strong><?= $var['kode_rencana']; ?></p>
                                                <p><strong>Tipe Dokumen : </strong><?= $var['tipe_rencana']; ?></p>
                                                <p><strong>Judul Dokumen : </strong><?= $var['judul']; ?></p>
                                                <p><strong>Tahun disahkan : </strong><?= $var['tahun']; ?></p>
                                                <p><strong>Tanggal Berlaku : </strong><?= $var['tgl_berlaku']; ?></p>
                                                <p><strong>Tanggal Berakhir : </strong><?= $var['tgl_berakhir']; ?></p>
                                                <p><strong>Nama Pengesah : </strong><?= $var['pengesah']; ?></p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
                                                <button type="submit" id="hapus_doc" class="btn btn-danger btn-sm">Hapus</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
