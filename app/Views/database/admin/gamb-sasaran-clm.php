        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Dokumen Rencana</li>
                            <li class="breadcrumb-item">Sasaran</li>
                            <li class="breadcrumb-item">Sasaran Intervensi</li>
                            <li class="breadcrumb-item active" aria-current="page">Estimasi Klaim</li>
                        </ol>
                    </nav>
                    <br>
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <?php if (!empty($inv2)) : ?>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('admin/gambut/rencana/sasaran') . '/' . $inv2[0]['idrencana']; ?>';"><?= $inv2[0]['judul']; ?></span></li>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('admin/gambut/rencana/sasaran-intervensi') . '/' . $inv2[0]['idtarget']; ?>';"><?= $inv2[0]['kode_target']; ?></span></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <button class="badge outline-badge-dark" href="#"><?= ($inv2[0]['kode_output_target']); ?></button>
                                </li>
                            <?php endif; ?>
                        </ol>
                    </nav>
                ...
                <div id="head-2" class="seperator-header layout-top-spacing">
                    <?php if (!empty($inv2)) : ?>
                        <h4 class="">DATA ESTIMASI KLAIM DALAM SASARAN INTERVENSI KODE <?= strtoupper($inv2[0]['kode_output_target']); ?></h4>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <div style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
                                    <?php if (!empty($inv2)) : ?>
                                        <form action="<?= ($inv2[0]['idtargetinv']); ?>/simpan_sasaran_claim" method="post">
                                            <div class="modal-body">
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="kodeoutcometarget">
                                                            <p>Masukkan kode claim.</p>
                                                        </label>
                                                        <input type="text" placeholder="Kode sasaran kegiatan..." class="form-control <?= ($validation->hasError('kodeoutcometarget')) ? 'is-invalid' : ''; ?>" id="kodeoutcometarget" name="kodeoutcometarget" value="<?= old('kodeoutcometarget'); ?>" autofocus>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('kodeoutcometarget'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label for="satuan">
                                                ...
                                                <input type="hidden" id="kodeoutputtarget" name="kodeoutputtarget" value="<?= ($inv2[0]['kode_output_target']); ?>">
                                            </div>
                                ...
                                <table id="user" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php foreach ($claim as $var) : ?>
                                            <tr>
                                                <td scope="row"><?= $no++; ?></td>
                                                <td><?= $var['kode_outcome_target']; ?></td>
                                                <td><?= $var['kode_output_target']; ?></td>
                                                <td><?= $var['satuan']; ?></td>
                                                <td><?= $var['volume']; ?></td>
                                                <td>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">UPDATE DATA ESTIMASI KLAIM</h5>
                                        ...
                                        <form action="<?= $var['idtargetinv']; ?>/edit_sasaran_claim/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="kodeoutcometarget">
                                                        <p>Sunting kode claim.</p>
                                                    </label>
                                                    <input id="kodeoutcometarget" type="text" name="kodeoutcometarget" value="<?= $var['kode_outcome_target']; ?>" class="form-control">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="kodeoutputtarget">
                                                        <p>Sunting kode sasaran intervensi.</p>
                                                    </label>
                                                    <select class="form-select" id="kodeoutputtarget" name="kodeoutputtarget" value="<?= $var['kode_output_target']; ?>">
                                                        <option selected><?= $var['kode_output_target']; ?></option>
                                                        <?php foreach ($inv as $var1) : ?>
                                                            <option value="<?= $var1['kode_output_target']; ?>"><?= $var1['kode_output_target']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                <div class="mb-3">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" id="edit_sasaran" class="btn btn-submit btn-sm">Simpan</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div id="hapus_kabkot">
                            <div class="modal fade" id="hapus_2<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">HAPUS DATA ESTIMASI KLAIM</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-rounded-x" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M10 10l4 4m0 -4l-4 4"></path>
                                        ...
                                        <form action="<?= $var['idtargetinv']; ?>/hapus_sasaran_claim/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <p><strong>Kode Sasaran Intervensi : </strong><?= $var['kode_outcome_target']; ?></p>
                                                <p><strong>Kode Claim : </strong><?= $var['kode_output_target']; ?></p>
                                                <p><strong>Satuan : </strong><?= $var['satuan']; ?></p>
                                                <p><strong>Volume : </strong><?= $var['volume']; ?></p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
                                                <button type="submit" id="hapus_sasaran" class="btn btn-danger btn-sm">Hapus</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
