            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <?php if (in_groups(['developer', 'web-master', 'super-admin', 'gambut-admin'])) : ?>
                    ...
                    <li class="menu active">
                        <a href="<?= base_url('/admin/gambut/rencana'); ?>" class="dropdown-toggle">
                            <div class="">
        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Dokumen Perencanaan</a></li>
                            <li class="breadcrumb-item"><a href="#">Rencana Kegiatan</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Alokasi Rencana Kegiatan</li>
                        </ol>
                    </nav>
                    <br>
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('admin/gambut/rencana'); ?>';">Data Dokumen Perencanaan</span></li>
                            <?php if (!empty($kegiatan2)) : ?>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('admin/gambut/rencana/kegiatan'); ?>/<?= ($kegiatan2[0]['idrencana']); ?>';"><?= ($kegiatan2[0]['judul']); ?></span></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <button class="badge outline-badge-dark" href="#"><?= ($kegiatan2[0]['kodekegiatan']); ?></button>
                                </li>
                            <?php endif; ?>
                        </ol>
                    </nav>
                ...
                <div id="head-2" class="seperator-header layout-top-spacing">
                    <?php if (!empty($kegiatan2)) : ?>
                        <h4 class="">DATA ALOKASI PERENCANAAN KEGIATAN DALAM <?= strtoupper($kegiatan2[0]['kodekegiatan']); ?></h4>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <div style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
                                    <?php if (!empty($kegiatan2)) : ?>
                                        <form action="<?= ($kegiatan2[0]['idkegiatan']); ?>/simpan_alokasi" method="post">
                                            <div class="modal-body">
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="kodealokasi">
                                                            <p>Masukkan kode alokasi perencanaan.</p>
                                                        </label>
                                                        <input type="text" placeholder="Kode rencana..." class="form-control <?= ($validation->hasError('kodealokasi')) ? 'is-invalid' : ''; ?>" id="kodealokasi" name="kodealokasi" value="<?= old('kodealokasi'); ?>" autofocus>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('kodealokasi'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label for="jenis">
                                                            <p>Masukkan jenis rencana.</p>
                                                        </label>
                                                        <input type="text" placeholder="Jenis rencana..." class="form-control <?= ($validation->hasError('jenis')) ? 'is-invalid' : ''; ?>" id="jenis" name="jenis" value="<?= old('jenis'); ?>">
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="pelaksana">
                                                            <p>Pilih kode pelaksana (UPRG).</p>
                                                        </label>
                                                        <select class="form-select <?= ($validation->hasError('pelaksana')) ? 'is-invalid' : ''; ?>" id="pelaksana" name="pelaksana" value="<?= old('pelaksana'); ?>">
                                                            <option disabled selected>Pilih...</option>
                                                            <?php foreach ($pelaksana as $var2) : ?>
                                                                <option value="<?= $var2['kode_pelaksana']; ?>"><?= $var2['kode_pelaksana']; ?> - <?= $var2['nama']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('pelaksana'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label for="desa">
                                                        ...
                                                        <select class="form-select <?= ($validation->hasError('desa')) ? 'is-invalid' : ''; ?>" id="desa" name="desa" value="<?= old('desa'); ?>">
                                                            <option disabled selected>Pilih...</option>
                                                            <?php foreach ($desa as $var2) : ?>
                                                                <option value="<?= $var2['kode_desa']; ?>"><?= $var2['kode_desa']; ?> - <?= $var2['nama_desa']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <select class="form-select <?= ($validation->hasError('hru')) ? 'is-invalid' : ''; ?>" id="hru" name="hru" value="<?= old('hru'); ?>">
                                                            <option disabled selected>Pilih...</option>
                                                            <?php foreach ($hru as $var2) : ?>
                                                                <option value="<?= $var2['kode_hru']; ?>"><?= $var2['kode_hru']; ?> - <?= $var2['nama_hru']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('hru'); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="lemdes">
                                                            <p>Pilih kode Lembaga Desa.</p>
                                                        </label>
                                                        <select class="form-select <?= ($validation->hasError('lemdes')) ? 'is-invalid' : ''; ?>" id="lemdes" name="lemdes" value="<?= old('lemdes'); ?>">
                                                            <option disabled selected>Pilih...</option>
                                                            <?php foreach ($lemdes as $var2) : ?>
                                                                <option value="<?= $var2['kode_lemdes']; ?>"><?= $var2['kode_lemdes']; ?> - <?= $var2['nama_lemdes']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('lemdes'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label for="produk">
                                                            <p>Masukkan jenis produk.</p>
                                                        </label>
                                                        <input type="text" placeholder="Produk..." class="form-control <?= ($validation->hasError('produk')) ? 'is-invalid' : ''; ?>" id="produk" name="produk" value="<?= old('produk'); ?>">
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <input type="text" placeholder="Satuan..." class="form-control <?= ($validation->hasError('satuan')) ? 'is-invalid' : ''; ?>" id="satuan" name="satuan" value="<?= old('satuan'); ?>">
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        ...
                                                        <input type="text" placeholder="Volume..." class="form-control <?= ($validation->hasError('volume')) ? 'is-invalid' : ''; ?>" id="volume" name="volume" value="<?= old('volume'); ?>">
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <input type="text" placeholder="Penanggung Jawab..." class="form-control <?= ($validation->hasError('pj')) ? 'is-invalid' : ''; ?>" id="pj" name="pj" value="<?= old('pj'); ?>">
                                                        <div class="invalid-feedback">
                                                ...
                                                <input type="hidden" id="kegiatan" name="kegiatan" value="<?= ($kegiatan2[0]['kodekegiatan']); ?>">
                                            </div>
                                            <div class="modal-footer">
                                                <button type="submit" id="simpan_subtindakan" class="btn btn-outline-success btn-sm">
                                ...
                                <table id="user" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php foreach ($alokasi as $var) : ?>
                                            <tr>
                                                <td scope="row"><?= $no++; ?></td>
                                                <td><?= $var['kode_alokasi']; ?></td>
                                                <td><?= $var['jenis_alokasi']; ?></td>
                                                <td><?= $var['kode_rencana_kegiatan']; ?></td>
                ...
                <!-- tabel data perencanan -->
                <!-- modal perencanan -->
                <div id="modal-alokasi">
                    <?php foreach ($alokasi as $var) : ?>
                        <div id="edit_alokasi">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">UPDATE DATA PERENCANAAN</h5>
                                        ...
                                        <form action="<?= $var['idkegiatan']; ?>/edit_alokasi/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label for="kodealokasi1">
                                                            <p>Sunting kode alokasi perencanaan.</p>
                                                        </label>
                                                        <input id="kodealokasi1" type="text" name="kodealokasi1" value="<?= $var['kode_alokasi']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="jenis1">
                                                            <p>Sunting jenis perencanaan.</p>
                                                        </label>
                                                        <input id="jenis1" type="text" name="jenis1" value="<?= $var['jenis_alokasi']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="kegiatan1">
                                                            <p>Sunting kode rencana kegiatan.</p>
                                                        </label>
                                                        <input id="kegiatan1" type="text" name="kegiatan1" value="<?= $var['kode_rencana_kegiatan']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label for="pelaksana1">
                                                            <p>Sunting kode pelaksana (UPRG).</p>
                                                        </label>
                                                        <input id="pelaksana1" type="text" name="pelaksana1" value="<?= $var['kode_pelaksana']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="desa1">
                                                            <p>Sunting kode Desa.</p>
                                                        </label>
                                                        <input id="desa1" type="text" name="desa1" value="<?= $var['kode_desa']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="hru1">
                                                            <p>Sunting kode HRU.</p>
                                                        </label>
                                                        <input id="hru1" type="text" name="hru1" value="<?= $var['kode_hru']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        ...
                                                        <input id="lemdes1" type="text" name="lemdes1" value="<?= $var['kode_lemdes']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="produk1">
                                                            <p>Sunting produk.</p>
                                                        </label>
                                                        <input id="produk1" type="text" name="produk1" value="<?= $var['produk']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="satuan1">
                                                            <p>Sunting satuan volume.</p>
                                                        </label>
                                                        <input id="satuan1" type="text" name="satuan1" value="<?= $var['satuan']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        ...
                                                        <input id="volume1" type="text" name="volume1" value="<?= $var['volume']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="pj1">
                                                            <p>Sunting nama penanggung jawab.</p>
                                                        </label>
                                                        <input id="pj1" type="text" name="pj1" value="<?= $var['pj']; ?>" class="form-control">
                                                    </div>
                                                    <div class="col">
                                                        <label for="deskripsi1">
                                                            <p>Sunting deskripsi.</p>
                                                        </label>
                                                        <input id="deskripsi1" type="text" name="deskripsi1" value="<?= $var['deskripsi']; ?>" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="row mb-4">
                                                    <div class="col">
                                                        <label for="satuan">
                                                            <p>*Gunakan titik sebagai separator desimal. <br>
                                                                **Silakan isi kode lemdes dan produk jika diperlukan, jika tidak silakan dikosongkan.</p>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" id="edit_alokasi" class="btn btn-submit btn-sm">Simpan</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="modal fade" id="hapus_1<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?= $var['idkegiatan']; ?>/hapus_alokasi/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <p><strong>Kode Perencanaan : </strong><?= $var['kode_alokasi']; ?></p>
                                                <p><strong>Jenis Perencanaan : </strong><?= $var['jenis_alokasi']; ?></p>
                                                <p><strong>Kode Rencana Kegiatan : </strong><?= $var['kode_rencana_kegiatan']; ?></p>
                                                <p><strong>Kode Pelaksana (UPRG) : </strong><?= $var['kode_pelaksana']; ?></p>
                                                ...
                                                <p><strong>Produk : </strong><?= $var['produk']; ?></p>
                                                <p><strong>Satuan : </strong><?= $var['satuan']; ?></p>
                                                <p><strong>Volume : </strong><?= $var['volume']; ?></p>
                                                <p><strong>Nama penangung jawab : </strong><?= $var['pj']; ?></p>
                                                <p><strong>Deskripsi : </strong><?= $var['deskripsi']; ?></p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
                                                <button type="submit" id="hapus_alokasi" class="btn btn-danger btn-sm">Hapus</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
