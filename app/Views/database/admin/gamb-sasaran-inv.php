        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Sasaran Intervensi</li>
                        </ol>
                    </nav>
                    <br>
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <?php if (!empty($sasaran2)) : ?>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('admin/gambut/rencana/sasaran') . '/' . $sasaran2[0]['idrencana']; ?>';"><?= $sasaran2[0]['judul']; ?></span></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <button class="badge outline-badge-dark" href="#"><?= ($sasaran2[0]['kode_target']); ?></button>
                                </li>
                            <?php endif; ?>
                        </ol>
                    </nav>
                ...
                <div id="head-2" class="seperator-header layout-top-spacing">
                    <?php if (!empty($sasaran2)) : ?>
                        <h4 class="">DATA SASARAN INTERVENSI DALAM SASARAN KODE <?= strtoupper($sasaran2[0]['kode_target']); ?></h4>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <div style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
                                    <?php if (!empty($sasaran2)) : ?>
                                        <form action="<?= ($sasaran2[0]['idtarget']); ?>/simpan_sasaran_inv" method="post">
                                            <div class="modal-body">
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="kodeoutputtarget">
                                                            <p>Masukkan kode sasaran intervensi.</p>
                                                        </label>
                                                        <input type="text" placeholder="Kode sasaran intervensi..." class="form-control <?= ($validation->hasError('kodeoutputtarget')) ? 'is-invalid' : ''; ?>" id="kodeoutputtarget" name="kodeoutputtarget" value="<?= old('kodeoutputtarget'); ?>" autofocus>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('kodeoutputtarget'); ?>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <label for="hru">
                                                        ...
                                                        <select class="form-select" id="hru" name="hru">
                                                            <option selected disabled>Pilih...</option>
                                                            <?php foreach ($hru as $var1) : ?>
                                                                <option value="<?= $var1['kode_hru']; ?>"><?= $var1['kode_hru']; ?> - <?= $var1['nama_hru']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col">
                                                        <label for="volume">
                                                            <p>Masukkan volume sasaran intervensi.</p>
                                                        </label>
                                                        <input type="text" placeholder="Volume..." class="form-control <?= ($validation->hasError('volume')) ? 'is-invalid' : ''; ?>" id="volume" name="volume" value="<?= old('volume'); ?>" autofocus>
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('volume'); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <input type="hidden" id="kodetarget" name="kodetarget" value="<?= ($sasaran2[0]['kode_target']); ?>">
                                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <a href="<?= base_url('admin/gambut/rencana/sasaran-claim/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-warning" title="Data claim">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">UPDATE DATA SASARAN INTERVENSI</h5>
                                        ...
                                        <form action="<?= $var['idtarget']; ?>/edit_sasaran_inv/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="kodeoutputtarget">
                                                        <p>Sunting kode sasaran kegiatan.</p>
                                                    </label>
                                                    <input id="kodeoutputtarget" type="text" name="kodeoutputtarget" value="<?= $var['kode_output_target']; ?>" class="form-control">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="kodetarget">
                                                        <p>Sunting kode sasaran.</p>
                                                    </label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input id="hru" type="text" name="hru" value="<?= $var['kode_hru']; ?>" class="form-control">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="satuan">
                        ...
                        <div id="hapus_kabkot">
                            <div class="modal fade" id="hapus_2<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">HAPUS DATA SASARAN INTERVENSI</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-rounded-x" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M10 10l4 4m0 -4l-4 4"></path>
                                        ...
                                        <form action="<?= $var['idrencana']; ?>/hapus_sasaran/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <p><strong>Kode Sasaran Intervensi : </strong><?= $var['kode_output_target']; ?></p>
