        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <?php if (!empty($doc2)) : ?>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <button class="badge outline-badge-dark" href="#"><?= ($doc2[0]['judul']); ?></button>
                                </li>
                            <?php endif; ?>
                        </ol>
                    </nav>
                ...
                <div id="head-2" class="seperator-header layout-top-spacing">
                    <?php if (!empty($doc2)) : ?>
                        <h4 class="">DATA KEGIATAN DALAM <?= strtoupper($doc2[0]['judul']); ?></h4>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <div style="padding-top: 5px; padding-left: 5px; padding-right: 5px;">
                                    <?php if (!empty($doc2)) : ?>
                                        <form action="<?= ($doc2[0]['idrencana']); ?>/simpan_kegiatan" method="post">
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col">
                                                        <label for="kodesubtindakan">
                                                            <p>Pilih kode sub arahan tindakan.</p>
                                                        </label>
                                                        <select class="form-select" id="kodesubtindakan" name="kodesubtindakan">
                                                            <option selected disabled>Pilih...</option>
                                                            <?php foreach ($subtindakan as $var1) : ?>
                                                                <option value="<?= $var1['kode_sub_tindakan_restorasi']; ?>"><?= $var1['kode_sub_tindakan_restorasi']; ?> - <?= $var1['nama_sub_tindakan_restorasi']; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    <div class="col">
                                                        <label for="kodekegiatan">
                                                            <p>Masukkan kode kegiatan.</p>
                                                        </label>
                                                        <input type="text" placeholder="Kode kegiatan..." class="form-control <?= ($validation->hasError('kodekegiatan')) ? 'is-invalid' : ''; ?>" id="kodekegiatan" name="kodekegiatan" value="<?= old('kodekegiatan'); ?>">
                                                        <div class="invalid-feedback">
                                                            <?= $validation->getError('kodekegiatan'); ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <input type="hidden" id="koderencana" name="koderencana" value="<?= ($doc2[0]['koderencana']); ?>">
                                            </div>
                                ...
                                <table id="user" class="table dt-table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Kode Dokumen</th>
                                            <th>Kode Sub Arahan Tindakan</th>
                                            <th>Kode Rencana Kegiatan</th>
                                            <th>Tindakan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php foreach ($kegiatan as $var) : ?>
                                            <tr>
                                                <td scope="row"><?= $no++; ?></td>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <a href="<?= base_url('admin/gambut/rencana/alokasi/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-warning" title="Data Alokasi Perencanaan Kegiatan">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalCenterTitle">UPDATE DATA RENCANA KEGIATAN</h5>
                                        ...
                                        <form action="<?= $var['idrencana']; ?>/edit_kegiatan/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="koderencana">
                                                        <p>Pilih kode dokumen perencanaan.</p>
                                                    </label>
                                                    <select class="form-select" id="koderencana" name="koderencana" value="<?= $var['koderencana']; ?>">
                                                        <option selected><?= $var['koderencana']; ?></option>
                                                        <?php foreach ($doc as $var1) : ?>
                                                            <option value="<?= $var1['kode_rencana']; ?>"><?= $var1['kode_rencana']; ?> - <?= $var1['judul']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="kodesubtindakan" name="kodesubtindakan" value="<?= $var['kode_sub_tindakan_restorasi']; ?>">
                                                        <option selected><?= $var['kode_sub_tindakan_restorasi']; ?></option>
                                                        <?php foreach ($subtindakan as $var1) : ?>
                                                            <option value="<?= $var1['kode_sub_tindakan_restorasi']; ?>"><?= $var1['kode_sub_tindakan_restorasi']; ?> - <?= $var1['nama_sub_tindakan_restorasi']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input id="kodekegiatan" type="text" name="kodekegiatan" value="<?= $var['kode_rencana_kegiatan']; ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
                                                <button type="submit" id="edit_kegiatan" class="btn btn-submit btn-sm">Simpan</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="modal fade" id="hapus_1<?= $var['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?= $var['idrencana']; ?>/hapus_kegiatan/<?= $var['id']; ?>" method="post">
                                            <div class="modal-body">
                                                ...
                                                <p><strong>Kode Sub Arahan Tindakan : </strong><?= $var['kode_sub_tindakan_restorasi']; ?></p>
                                                <p><strong>Kode Rencana Kegiatan : </strong><?= $var['kode_rencana_kegiatan']; ?></p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm" data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i>Batal</button>
                                                <button type="submit" id="hapus_kegiatan" class="btn btn-danger btn-sm">Hapus</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
