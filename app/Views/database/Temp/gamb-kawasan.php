        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data Kawasan Gambut</li>
                        </ol>
                    </nav>
                </div>
                <!-- /BREADCRUMB -->
                ...
                <div id="head-1" class="seperator-header layout-top-spacing">
                    <h4 class="">TABEL DATA KESATUAN HIDROLOGIS GAMBUT</h4>
                </div>
                                ...
                                <table id="tabel-1" class="table dt-table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nama KHG</th>
                                            <th>Kode Provinsi</th>
                                            <th>Luas F. Lindung</th>
                                            <th>Luas F. Budidaya</th>
                                            <th>Luas</th>
                                            <th>Satuan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <?php foreach ($khg as $var) : ?>
                                            <tr>
                                                ...
                                                <td><?= $var['nama']; ?></td>
                                                <td><?= $var['kode_prov']; ?></td>
                                                <td><?= $var['fungsi_lindung']; ?></td>
                                                <td><?= $var['fungsi_budidaya']; ?></td>
                                                <td><?= $var['luas']; ?></td>
                                                <td><?= $var['satuan']; ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                ...
                <div id="head-2" class="seperator-header layout-top-spacing">
                    <h4 class="">TABEL DATA SUB-KESATUAN HIDROLOGIS GAMBUT</h4>
                </div>
                ...
                <div id="head-3" class="seperator-header layout-top-spacing">
                    <h4 class="">TABEL DATA <i>HYDROLOGICAL RESPONSE UNITS</i></h4>
                </div>
