    ...
    <div class="sidebar-wrapper sidebar-theme">
        ...
        <nav id="sidebar">
                ...
                <div class="nav-logo">
                    <div class="nav-item theme-logo">
                        <a href="<?= base_url('/gambut'); ?>">
                            <img src="<?= base_url('dashboard/src/assets/img/logo.svg') ?>" class="navbar-logo">
                        </a>
                    </div>
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <!-- dokumen kegiatan -->
                <li class="menu">
                    <a href="<?= base_url('/gambut/dokumen'); ?>" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                ...
                <!-- perencanaan gambut -->
                <li class="menu">
                    <a href="#perencanaangambut" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity">
                    ...
                    <ul class="collapse submenu list-unstyled" id="perencanaangambut" data-bs-parent="#accordionExample">
                        <li>
                            <a href="<?= base_url('/gambut/perencanaan'); ?>"> Perencanaan</a>
                        </li>
                        <li>
                            <a href="<?= base_url('/gambut/survey'); ?>"> Survey </a>
                        </li>
                    </ul>
                </li>
                <!-- /perencanaan gambut -->
        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data Kegiatan & Arahan Tindakan</li>
                        </ol>
                    </nav>
                </div>
                <!-- /BREADCRUMB -->
                ...
                <div id="head-1" class="seperator-header layout-top-spacing">
                    <h4 class="">TABEL DATA ARAHAN TINDAKAN</h4>
                </div>
                ...
                <div id="head-2" class="seperator-header layout-top-spacing">
                    <h4 class="">TABEL DATA SUB-ARAHAN TINDAKAN</h4>
                </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <table id="tabel-2" class="table dt-table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Kode Tindakan</th>
                                            <th>Kode Sub-Tindakan</th>
                                            <th>Nama Sub-Tindakan</th>
                                            <th>Volume</th>
                                            <th>Satuan</th>
                                            <th>PJ</th>
                                            <th>Deskripsi</th>
                ...
                <div id="head-3" class="seperator-header layout-top-spacing">
                    <h4 class="">TABEL DATA KEGIATAN</h4>
                </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area">
                                ...
                                <table id="tabel-3" class="table dt-table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>No.</th>
                                            <th>Kode Tindakan</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($kegiatan as $var) : ?>
                                            <tr>
                                                <td scope="row"><?= $no++; ?></td>
                                                <td><?= $var['kode_tindakan_restorasi']; ?></td>
                                                <td><?= $var['kode_kegiatan']; ?></td>
                                                <td><?= $var['nama_kegiatan']; ?></td>
                                                <td><?= $var['deskripsi']; ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
