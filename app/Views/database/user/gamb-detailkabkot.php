                    ...
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <?php if (!empty($kabkot2)) : ?>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/administrasi/prov/') . '/' . $kabkot2[0]['idprov']; ?>';"><?= $kabkot2[0]['nama_prov']; ?></span></li>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($kec as $var) : ?>
                                            <tr>
                                                ...
                                                <td><?= $var['nama_kec']; ?></td>
                                                <td>
                                                    <a href="<?= base_url('gambut/administrasi/kec/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-success" title="Data Desa">
