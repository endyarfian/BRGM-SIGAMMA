                    ...
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <?php if (!empty($sasaran2)) : ?>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/rencana/sasaran') . '/' . $sasaran2[0]['idrencana']; ?>';"><?= $sasaran2[0]['judul']; ?></span></li>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($inv as $var) : ?>
                                            <tr>
                                                ...
                                                <td><?= $var['volume']; ?></td>
                                                <td>
                                                    <a href="<?= base_url('/gambut/rencana/sasaran-claim/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-success" title="Data claim">
