                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">Arahan Tindakan</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Sub Arahan Tindakan</li>
                        </ol>
                    </nav>
                    <br>
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/tindakan'); ?>';">Data Arahan Tindakan</span></li>
                                ...
                                <table id="tabel-2" class="table dt-table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nama Sub Arahan Tindakan</th>
                                            <th>Deskripsi</th>
                                        </tr>
                                    </thead>
                                    <tbody>
