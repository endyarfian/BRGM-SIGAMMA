        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                    ...
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <?php if (!empty($kegiatan2)) : ?>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/rencana/kegiatan'); ?>/<?= ($kegiatan2[0]['idrencana']); ?>';"><?= ($kegiatan2[0]['judul']); ?></span></li>
                ...
                <div id="head-2" class="seperator-header layout-top-spacing">
                    <?php if (!empty($kegiatan2)) : ?>
                        <h4 class="">DATA ALOKASI PERENCANAAN KEGIATAN DALAM KODE KEGIATAN <?= strtoupper($kegiatan2[0]['kodekegiatan']); ?></h4>
                    <?php endif; ?>
                </div>
