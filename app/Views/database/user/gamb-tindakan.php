        ...
        <div class="layout-px-spacing">
            <div class="middle-content container-xxl p-0">
                ...
                <div id="head-2" class="seperator-header layout-top-spacing">
                    <h4 class="">DATA ARAHAN TINDAKAN RESTORASI DALAM DOKUMEN</h4>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($tindakan as $var) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('gambut/tindakan/subtindakan/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-success" title="Data Sub-tindakan">
