            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    ...
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/kawasan'); ?>';">Data Semua KHG</span></li>
                            <?php if (!empty($khg2)) : ?>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($subkhg as $var) : ?>
                                            <tr>
                                                ...
                                                <td><?= $var['satuan']; ?></td>
                                                <td>
                                                    <a href="<?= base_url('gambut/kawasan/subkhg/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-success" title="Data Sub-KHG">
