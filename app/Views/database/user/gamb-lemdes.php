                ...
                <div class="page-meta">
                    ...
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <?php if (!empty($desa2)) : ?>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/administrasi/prov/') . '/' . $desa2[0]['idprov']; ?>';"><?= $desa2[0]['nama_prov']; ?></span></li>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/administrasi/kabkot/') . '/' . $desa2[0]['idkabkot']; ?>';"><?= $desa2[0]['nama_kabkot']; ?></span></li>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/administrasi/kec/') . '/' . $desa2[0]['idkec']; ?>';"><?= $desa2[0]['nama_kec']; ?></span></li>
