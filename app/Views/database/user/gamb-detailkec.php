            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    ...
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/administrasi'); ?>';">Data Semua Provinsi</span></li>
                            <?php if (!empty($kec2)) : ?>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/administrasi/prov/') . '/' . $kec2[0]['idprov']; ?>';"><?= $kec2[0]['nama_prov']; ?></span></li>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/administrasi/kabkot/') . '/' . $kec2[0]['idkabkot']; ?>';"><?= $kec2[0]['nama_kabkot']; ?></span></li>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($desa as $var) : ?>
                                            <tr>
                                                ...
                                                <td><?= $var['nama_desa']; ?></td>
                                                <td>
                                                    <a href="<?= base_url('gambut/administrasi/lemdes/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-success" title="Data Desa">
