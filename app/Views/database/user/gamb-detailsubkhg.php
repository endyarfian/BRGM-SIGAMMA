                    ...
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <?php if (!empty($subkhg2)) : ?>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/kawasan/khg/') . '/' . $subkhg2[0]['idkhg']; ?>';"><?= ($subkhg2[0]['namakhg']); ?></span></li>
