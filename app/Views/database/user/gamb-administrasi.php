                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="<?= base_url('/gambut/administrasi/pelaksana/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-warning" title="Data Pelaksana">
                                                        ...
                                                        <a href="<?= base_url('/gambut/administrasi/prov/'); ?>/<?= $var['id']; ?>" type="button" class="btn btn-outline-success" title="Data Kabupaten/Kota">
