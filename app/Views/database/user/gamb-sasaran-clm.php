            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="page-meta">
                    ...
                    <nav class="breadcrumb-style-four  mb-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/rencana'); ?>';">Data Dokumen Perencanaan</span></li>
                            <?php if (!empty($inv2)) : ?>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/rencana/sasaran') . '/' . $inv2[0]['idrencana']; ?>';"><?= $inv2[0]['judul']; ?></span></li>
                                <li class="breadcrumb-item"><span role="button" class="badge outline-badge-success" onclick="window.location.href = '<?= base_url('gambut/rencana/sasaran-intervensi') . '/' . $inv2[0]['idtarget']; ?>';"><?= $inv2[0]['kode_target']; ?></span></li>
