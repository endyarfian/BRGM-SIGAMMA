...
<head>
    ...
    <script src="<?= base_url('dashboard/src/assets/js/jquery.min.js') ?>"></script>
...
<body class="layout-boxed alt-menu">
    ...
    <!-- <script src="<?= base_url('dashboard/src/assets/js/dashboard/dash_1.js') ?>"></script> -->

    <script src="<?= base_url('dashboard/src/assets/js/grafikgambut.js') ?>"></script>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
