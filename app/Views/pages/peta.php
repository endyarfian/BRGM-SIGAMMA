            ...
            <div class="container">
                ...
                <div class="page-meta">
                    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/dashboard-gambut">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Peta Interaktif</li>
                        </ol>
                    </nav>
                </div>
                <!-- /BREADCRUMB -->
                ...
                <div class="row">
                    ...
                    <div id="mapBasic" class="col-lg-12 layout-top-spacing layout-spacing">
                        <div class="statbox widget box box-shadow" style="width: 156%;">
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h4>PETA KAWASAN HIDROLOGIS GAMBUT</h4>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                <li><a class="dropdown-item" href="#">Peta Gambut</a></li>
                                                <li><a class="dropdown-item" href="#">Peta Mangrove</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
