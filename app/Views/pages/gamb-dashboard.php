                ...
                <div class="row layout-top-spacing">
                                    ...
                                    <div class="task-action">
                                        <div class="dropdown">
                                            <a class="dropdown-toggle" href="#" role="button" id="expenses" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-grip-vertical" width="32" height="32" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        ...
                        <div class="widget widget-card-three">
                            <div class="widget-content">
                                <div class="account-box">
                                    <div class="info">
                                        <div class="inv-title">
                                            <h5 class="">DASHBOARD<br>GAMBUT</h5>
                                        </div>
                                        <div class="inv-balance-info">
                                            ...
                                            <span class="inv-stats balance-credited">Badan Restorasi Gambut dan Magrove</span>
                                        </div>
                                    </div>
                                    <div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-chart-three">
                            <div class="widget-heading">
                                <div class="">
                                    <h5 class="">DISTRIBUSI JUMLAH KHG, SUB KHG, DAN HRU MENURUT PROVINSI</h5>
                                </div>
                            </div>
                            <div class="widget-content">
                                <div id="kawasan"></div>
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-chart-two">
                            <div class="widget-heading">
                                <div class="">
                                    <h5 class="">DISTRIBUSI LUASAN GAMBUT</h5>
                                </div>
                            </div>
                            <div class="widget-content">
                                <div id="luasan" class=""></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-chart-three">
                            <div class="widget-heading">
                                <div class="">
                                    <h5 class="">DATA ADMINISTRASI BERDASARKAN PROVINSI</h5>
                                </div>
                            </div>
                            <div class="widget-content">
                                <div id="administrasi"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
